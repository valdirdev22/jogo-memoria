...
for (let i = 1; i <= 8; i++) imagens.push(`../Jogo_Arthur/id/${i}/100`);
...
onload = () => {
    ...
    document.body.style.backgroundImage = "url('./img/back_3.jpg')";
};
...
temCartaVirada = false;
 ...
 if(pontos == 6) {
    ...
    document.querySelector('.titulo').textContent ='Parabéns corintiano!';
    document.querySelector('.titulo').style.backgroundColor ='#FFBF00';  
    document.querySelector('#matematica').style.backgroundColor = '#FFBF00';   
    document.body.style.backgroundImage = "url('./img/back_corin_1.jpg')";
    timerDoJogo.stop(); 
}     
